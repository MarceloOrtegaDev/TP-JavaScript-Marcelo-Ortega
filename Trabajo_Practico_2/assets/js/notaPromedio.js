...
let promedio = (notaAlumno1 + notaAlumno2 + notaAlumno3) / 3;

if(isNaN(notaAlumno1) || isNaN(notaAlumno2) || isNaN(notaAlumno3)) {
    document.write('Por favor ingrese valores distintos a vacios o iguales a numeros');
}else if (notaAlumno1 < 1 || notaAlumno1 > 10 || notaAlumno2 < 1 || notaAlumno2 > 10 || notaAlumno3 < 1 || notaAlumno3 > 10){
